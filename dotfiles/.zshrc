...
plugins=(git history zsh-interactive-cd taskwarrior zsh-autosuggestions)
...
export PATH="/home/rationalpigeon/.local/bin:$PATH"
alias love2d="/mnt/d/Program\ Files/LOVE/love.exe"
alias aseprite="/mnt/d/Pixel\ Art/Aseprite.1.2.32_YasDL.com/Aseprite.exe"
mcd () {
	mkdir -p "$1"
	cd "$1"
}
